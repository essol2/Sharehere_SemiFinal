...
public class PageInfoForHst {
	...
	public PageInfoForHst() {}
	
	// 페이징처리 계산에 필요한 값을 받아 start, end, maxPage 계산하여 세팅
	public PageInfoForHst(int currentPage, int listCount, int pageLimit, int rmLimit) {
		super();
	...
	public PageInfoForHst(int currentPage, int listCount, int pageLimit, int rmLimit, int maxPage, int startPage,
			int endPage) {
		super();
		this.currentPage = currentPage;
		this.listCount = listCount;
