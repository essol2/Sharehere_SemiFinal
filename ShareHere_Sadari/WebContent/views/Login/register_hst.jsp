...
<style>
   ...
   font-weight: bold;
    ...
    #bsnameresult{margin-bottom: 20px;}
    /*버튼 옆에 띄우기 위해 */
...
<body>
    <section>
        <div class="wrap">
            ...
            action="<%= request.getContextPath() %>/member/inserthost" onsubmit="return joinValidate();">

                    <label class="block">사업자번호(-없이)</label><input type="text" id="bsnum" name="bsnum" maxlength="10"><span id="bsnumresult"></span>
                    <label class="block">상호명</label><input type="text" id="bsname" name="bsname">
